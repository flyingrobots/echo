...
use rmg_geom::temporal::temporal_transform::TemporalTransform;
...
fn fat_aabb_covers_start_and_end_poses() {
    ...
    let t1 = Transform::new(Vec3::new(10.0, 0.0, 0.0), Quat::identity(), Vec3::new(1.0, 1.0, 1.0));
    let tt = TemporalTransform::new(t0, t1);
