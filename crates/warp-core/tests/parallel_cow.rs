...
#![allow(clippy::todo)]
//! Parallel Execution COW Overlay Semantics Tests (ADR-0007 §5)
//!
...
#[test]
#[ignore = "COW-001: Parallel COW overlay not yet implemented"]
...
#[test]
#[ignore = "COW-002: Parallel COW overlay not yet implemented"]
...
#[test]
#[ignore = "COW-003: Parallel COW overlay not yet implemented"]
...
// If parallel_snapshot.rs is added later, consider moving this test there as t1_3.
// =============================================================================

// TODO(COW-004): Implement once reachability harness is wired.
#[test]
#[ignore = "COW-004: Parallel reachability not yet wired to harness"]
...
#[test]
#[ignore = "COW-005: Parallel DeltaView not yet implemented"]
...
#[test]
#[ignore = "COW-006: Parallel DeltaView not yet implemented"]
