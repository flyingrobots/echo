...
pub fn draw_view_hud(
    ...
    egui::Area::new("controls".into())
        ...
        .show(ctx, |ui| {
            ui.label("WASD/QE move, L-drag look, R-drag spin, Wheel zoom, Arrows cycle WARP id");
    ...
    egui::Area::new("stats".into())
        ...
        .show(ctx, |ui| {
            ...
            ui.label(format!("WARP id {} | epoch {}", app.ui.warp_id, epoch));
        });
    ...
    match app.ui.overlay {
        ...
        ViewerOverlay::Menu => {
            egui::CentralPanel::default().show(ctx, |ui| {
                ui.vertical_centered(|ui| {
                    ...
                    if ui.button("Publish Local WARP").clicked() {
                        app.apply_ui_event(UiEvent::OpenPublishOverlay);
                    }
                    if ui.button("Subscribe to WARP").clicked() {
        ...
        ViewerOverlay::Subscribe => {
            egui::CentralPanel::default().show(ctx, |ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut warp_id)
                            .speed(1)
                            .prefix("WARP id: "),
                    )
                    .changed()
