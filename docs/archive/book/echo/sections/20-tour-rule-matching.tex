...
\begin{bigpicture}
The footprint is the foundation of parallel execution safety. Two rewrites can execute in parallel if and only if their footprints don't overlap (read-read is allowed, but read-write or write-write conflicts).
