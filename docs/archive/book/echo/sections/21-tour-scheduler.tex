...
\begin{bigpicture}
The scheduler is the traffic cop of Echo. It takes a queue of pending rewrites and determines which ones can execute in this tick without conflicting. The output is a deterministic list of \texttt{ExecItem}s ready for parallel execution.
\end{bigpicture}
