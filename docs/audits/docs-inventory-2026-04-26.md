...
## docs/method/backlog/cool-ideas/KERNEL_rulial-diff.md

| filepath                                               | description                        | score | decision          | new filepath                                           | remarks                                                                                                                                                                                                                                                                                          |
| ------------------------------------------------------ | ---------------------------------- | ----- | ----------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/method/backlog/cool-ideas/KERNEL_rulial-diff.md` | Active Rulial/worldline-diff idea. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_rulial-diff.md` | Task DAG issues `#172`, `#199`, and `#204` remain live and blocked by TT2. `PlaybackCursor`, checkpoint-backed seek, provenance checkpoints/forks, and playback/provenance specs exist, but no public diff CLI or inspector diff protocol exists yet. Removed stale branch/wormhole terminology. |

---

## docs/method/backlog/cool-ideas/KERNEL_splash-guy-controlled-desync.md

| filepath                                                                | description                               | score | decision          | new filepath                                                            | remarks                                                                                                                                                                                                                                         |
| ----------------------------------------------------------------------- | ----------------------------------------- | ----- | ----------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_splash-guy-controlled-desync.md` | Active Splash Guy controlled-desync task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_splash-guy-controlled-desync.md` | Task DAG issue `#224`, `docs/guide/splash-guy.md`, and the course shell keep this as live execution work, but no controlled-desync harness exists. Replaced stale skeleton/GDD language and clarified the `DFix64`/`F32Scalar` bypass scenario. |

---

## docs/method/backlog/cool-ideas/KERNEL_splash-guy-lockstep-protocol.md

| filepath                                                                | description                      | score | decision          | new filepath                                                            | remarks                                                                                                                                                                                                                     |
| ----------------------------------------------------------------------- | -------------------------------- | ----- | ----------------- | ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_splash-guy-lockstep-protocol.md` | Active Splash Guy lockstep task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_splash-guy-lockstep-protocol.md` | Task DAG issue `#223` is live and `docs/guide/course/01-lockstep.md` teaches the intended contract, but there is no Splash Guy two-peer harness yet. Replaced stale skeleton/GDD language and narrowed the harness wording. |

---

## docs/method/backlog/cool-ideas/KERNEL_splash-guy-rules-and-state.md

| filepath                                                              | description                         | score | decision          | new filepath                                                          | remarks                                                                                                                                                                                                             |
| --------------------------------------------------------------------- | ----------------------------------- | ----- | ----------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_splash-guy-rules-and-state.md` | Active Splash Guy rules/state task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_splash-guy-rules-and-state.md` | Task DAG issue `#222` and `docs/guide/splash-guy.md` make this active, while no Splash Guy simulation crate/harness exists. Replaced stale skeleton/GDD language and removed the obsolete First Light blocker note. |
...
| filepath                                                   | description                          | score | decision          | new filepath                                               | remarks                                                                                                                                                                                                                                                                                              |
| ---------------------------------------------------------- | ------------------------------------ | ----- | ----------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_time-travel-mvp.md` | Active Time Travel MVP backlog item. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_time-travel-mvp.md` | Task DAG issues `#171` and `#205` remain live. `PlaybackCursor`, checkpoint-backed seek, provenance checkpoint/fork tests, `ttd-browser`, and the TTD UI shell prove partial substrate exists, but pause/buffer/catch-up capability semantics and integrated Reliving debugger behavior remain open. |

---

## docs/method/backlog/cool-ideas/KERNEL_tumble-tower-desync-breakers.md

| filepath                                                                | description                              | score | decision          | new filepath                                                            | remarks                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------------------- | ---------------------------------------- | ----- | ----------------- | ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_tumble-tower-desync-breakers.md` | Active Tumble Tower desync-breaker task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_tumble-tower-desync-breakers.md` | Task DAG issue `#236`, `docs/guide/tumble-tower.md`, and the Tumble Tower course dependency keep this operational. `F32Scalar` has deterministic LUT-backed trig, but no Tumble Tower physics simulation, lockstep harness, or breaker toggles exist yet. |

---

## docs/method/backlog/cool-ideas/KERNEL_tumble-tower-lockstep-harness.md

| filepath                                                                 | description                                | score | decision          | new filepath                                                             | remarks                                                                                                                                                                                                                                           |
| ------------------------------------------------------------------------ | ------------------------------------------ | ----- | ----------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_tumble-tower-lockstep-harness.md` | Active Tumble Tower lockstep-harness task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_tumble-tower-lockstep-harness.md` | Task DAG issue `#235`, `docs/guide/tumble-tower.md`, and the course dependency keep this operational, but no Tumble Tower physics simulation or two-peer harness exists. Corrected the stale assumption that a Splash Guy harness already exists. |

---

## docs/method/backlog/cool-ideas/KERNEL_worldline-convergence.md

| filepath                                                         | description                                       | score | decision          | new filepath                                                     | remarks                                                                                                                                                                                                                                                                          |
| ---------------------------------------------------------------- | ------------------------------------------------- | ----- | ----------------- | ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/KERNEL_worldline-convergence.md` | Active worldline convergence property-suite task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/KERNEL_worldline-convergence.md` | Task DAG issue `#187` remains open. `PlaybackCursor`, checkpoint-backed seek tests, fork tests, tick-patch replay, slice-theorem tests, and commit/state-root specs prove substantial substrate exists; narrowed the card to the missing generalized convergence property suite. |

---

## docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-0-aabb.md

| filepath                                                           | description                               | score | decision          | new filepath                                                       | remarks                                                                                                                                                                                                                                                                                        |
| ------------------------------------------------------------------ | ----------------------------------------- | ----- | ----------------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-0-aabb.md` | Active Tumble Tower Stage 0 physics task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-0-aabb.md` | Task DAG issue `#231` remains open and blocks the Tumble Tower ladder/course. `crates/warp-geom` provides AABB geometry and deterministic broad-phase scaffolding, but no gravity/contact-resolution simulation or physics fingerprint exists yet. Removed stale skeleton/First Light framing. |

---

## docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-1-rotation.md

| filepath                                                               | description                                | score | decision          | new filepath                                                           | remarks                                                                                                                                                                                                                                                                         |
| ---------------------------------------------------------------------- | ------------------------------------------ | ----- | ----------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-1-rotation.md` | Active Tumble Tower Stage 1 rotation task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-1-rotation.md` | Task DAG issue `#232` remains open and is blocked by Stage 0. `F32Scalar::sin_cos` and trig golden-vector tests exist, but no Tumble Tower OBB, angular dynamics, contact manifold, or torque solver exists yet. Corrected the trig API reference to the public scalar surface. |

---

## docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-2-friction.md

| filepath                                                               | description                                | score | decision          | new filepath                                                           | remarks                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------- | ------------------------------------------ | ----- | ----------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-2-friction.md` | Active Tumble Tower Stage 2 friction task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-2-friction.md` | Task DAG issue `#233` remains open and is blocked by Stage 1. `docs/guide/tumble-tower.md` defines friction/restitution as Stage 2, but no Tumble Tower contact solver, material model, or physics fingerprint exists yet. Removed stale skeleton framing. |

---

## docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-3-sleeping.md

| filepath                                                               | description                                | score | decision          | new filepath                                                           | remarks                                                                                                                                                                                                                                                 |
| ---------------------------------------------------------------------- | ------------------------------------------ | ----- | ----------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-3-sleeping.md` | Active Tumble Tower Stage 3 sleeping task. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/MATH_tumble-tower-stage-3-sleeping.md` | Task DAG issue `#234` remains open and is blocked by Stage 2. `docs/guide/tumble-tower.md` defines sleeping/islands as Stage 3, but no Tumble Tower solver, sleep-state model, island builder, or benchmark exists yet. Removed stale skeleton framing. |

---

## docs/method/backlog/cool-ideas/PLATFORM_cross-repo-method-dashboard.md

| filepath                                                                 | description                              | score | decision          | new filepath                                                             | remarks                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------ | ---------------------------------------- | ----- | ----------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/method/backlog/cool-ideas/PLATFORM_cross-repo-method-dashboard.md` | Active cross-repo Method dashboard idea. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/PLATFORM_cross-repo-method-dashboard.md` | `cargo xtask method status --json`, `crates/method`, and local sibling repos keep this operational, but no cross-repo aggregation tool exists and `git-warp` is not present in this checkout. Expanded the sparse note into a bounded implementation handle. |

---

## docs/method/backlog/cool-ideas/PLATFORM_deep-storage-api-evolution.md

| filepath                                                                | description                                 | score | decision          | new filepath                                                            | remarks                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------- | ------------------------------------------- | ----- | ----------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/method/backlog/cool-ideas/PLATFORM_deep-storage-api-evolution.md` | Active echo-cas API evolution backlog item. | `3/5` | Keep and correct. | `docs/method/backlog/cool-ideas/PLATFORM_deep-storage-api-evolution.md` | `crates/echo-cas` has `BlobStore` and `MemoryTier`; the current trait still returns `Arc<[u8]>` and no `DiskTier`, `TieredStore`, `AsyncBlobStore`, `BlobMeta`, or `StoreStats` exists. Added explicit current-status framing. |

---

## docs/method/backlog/cool-ideas/PLATFORM_deep-storage-disk-tier.md
