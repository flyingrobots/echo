...
\begin{enumerate}
    ...
    \item \textbf{Time \& Simulation (Timecube):} Manages the temporal axes:
        ...
        \end{itemize}
    \item \textbf{MaterializationBus:} A deterministic event bus used for communication between systems and for bridging the gap between the Core and the Ports. See ADR-0003 (MaterializationBus).
\end{enumerate}
