...
\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Git-style branching: Chronos is the main line, Kairos branches diverge and deterministically merge; checkpoints use snapshot hashes (Aion weighting optional).}
