...
The RMG Viewer is a thin, rendering-first client. It connects to the Echo Session Host, subscribes to one or more RMG streams, and presents a minimal HUD over a 3D scene. This section fixes the viewer19s states, transitions, and on-screen layout so the implementation and the design stay in lockstep.
