...
At the protocol level, the Viewer is ``just'' a client app in the RMG
streaming pipeline. It follows the generic snapshot/diff consumer contract in
Section~\ref{sec:rmg-stream-consumers} and sits in the ``Client App'' row of
Table~\ref{tab:rmg-role-summary}; what is specific here is \emph{how} it
projects those RMGs into a 3D ring and UI.
