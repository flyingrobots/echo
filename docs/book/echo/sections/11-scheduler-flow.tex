...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}[node distance=1.8cm and 1.8cm, >=stealth]
    ...
    \end{tikzpicture}
    \caption{Codex’s Baby (radix scheduler) keeps ordering stable via bucketed drains; conflicts are resolved deterministically before commits.}
\end{figure}
