...
| --- | --- | --- |
| Understand determinism + rewrite scheduling in Rust | `docs/spec-warp-core.md` | `docs/scheduler-reserve-validation.md`, `docs/scheduler-reserve-complexity.md` |
...
| Benchmark rewrite scheduler throughput | `docs/scheduler-benchmarks.md` | `crates/warp-benches/benches/scheduler_drain.rs` |
...
- Reserve validation and evidence: `docs/scheduler-reserve-validation.md`
- Reserve time complexity notes: `docs/scheduler-reserve-complexity.md`
- Bench plan + current benches: `docs/scheduler-benchmarks.md`
