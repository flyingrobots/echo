...
**Status (2026-01-02): not yet re-specified.** This repo currently carries an interactive DPO tour and diagram assets, but the full written spec for Echo’s geometry/collision subsystem is pending re-homing into the Rust-first era.
...
- Diagram assets: `docs/assets/collision/`

What this spec should eventually cover:
- Deterministic broad phase + narrow phase modeling as graph rewrites (DPO).
