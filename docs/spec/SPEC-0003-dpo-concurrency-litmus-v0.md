...
It is intentionally “low ceremony”: the goal is to pin _executable evidence_ (litmus tests) that match the theory-shaped intent without claiming we have implemented full categorical DPO.
