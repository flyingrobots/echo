...
\usepackage{warp-macros}

\title{Rulial Distance as a Pseudometric via MDL Translators}
\author{WARP Core Project}
\date{November 6, 2025}

\begin{document}
\maketitle

\section{Observers and translators}
Fix an WARP universe $(U,R)$ and its history category $\mathrm{Hist}(U,R)$.
...
\section{Distance}
Define the symmetric distance under budgets $(\tau,m)$
\[
