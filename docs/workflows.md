...
- `cargo xtask doghouse sortie 308 --intent merge-check` emits agent-native JSONL for the selected PR, including sortie intent, baseline selection, comparison trust/quality assessment, semantic delta, and an intent-aware next-action verdict.
